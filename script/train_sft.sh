CUDA_VISIBLE_DEVICES=0,2,3 torchrun --nnodes 1 --node_rank 0 --nproc_per_node 1  --master_addr 127.0.0.1 --master_port 23949\
                    src/train.py --output_dir ./save/sft/metaqa/keallm/lora \
                    --stage sft \
                    --hop 1-hop \
